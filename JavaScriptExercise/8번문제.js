...
console.log(typeSwitch("10"), typeof typeSwitch("10"));
console.log(typeSwitch("531"), typeof typeSwitch("531"));
console.log(typeSwitch("abc"), typeof typeSwitch("abc"));
console.log(typeSwitch("123"), typeof typeSwitch("123"));
